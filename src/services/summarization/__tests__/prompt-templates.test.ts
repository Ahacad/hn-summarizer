...
describe('Prompt Templates', () => {
  ...
  describe('Summary Template', () => {
    ...
    it('should provide clear formatting instructions', () => {
      expect(promptTemplates.summary).toContain('Format your response exactly as:');
    });
  });
  ...
  describe('Key Info Template', () => {
    ...
    it('should request extraction of specific information types', () => {
      expect(promptTemplates.keyInfo).toContain('Important facts and statistics');
      expect(promptTemplates.keyInfo).toContain('Relevant names, organizations, or products');
      expect(promptTemplates.keyInfo).toContain('Key dates or timeline information');
    });
  });
