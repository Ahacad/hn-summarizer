...
describe('StoryRepository', () => {
  ...
  describe('getStoriesByStatus', () => {
    it('should retrieve stories by status', async () => {
      const stories = await repository.getStoriesByStatus(ProcessingStatus.PENDING);
    ...
    it('should respect the limit parameter', async () => {
      ...
      const stories = await repository.getStoriesByStatus(ProcessingStatus.PENDING, 3);
